import mock
from simpl.customers.customer import Merchant, User
from simpl.reporting import Reporting
from simpl.transact import Transact

from simpl.main import create_new_transaction, create_user_or_merchant, main
...
class TestMain:
    ...
    def test_main_create_new_user(self):
        ...
        assert create_user_or_merchant(
            "ravinder", "ra@gmail.com", 1000, input_type["report_object"], input_type["class_name"]) == "ravinder(1000)"

    def test_main_create_new_user_negative(self):
        input_type = self.class_map["user"]
        try:
            create_user_or_merchant("ravinder", "ra@gmail.com", 1000,
                                    input_type["report_object"], input_type["class_name"])
            assert False
    ...
    def test_main_create_new_user_name_format_negative(self):
        input_type = self.class_map["user"]
        try:
            create_user_or_merchant(
                "r123", "r@gmail.com", 1000, input_type["report_object"], input_type["class_name"])
            assert False
        except Exception as e:
    ...
    def test_main_create_new_merchant(self):
        ...
        assert create_user_or_merchant(
            "merchant", "ra@gmail.com", 10, input_type["report_object"], input_type["class_name"]) == "merchant(10)"

    def test_main_create_new_merchant_negative(self):
        input_type = self.class_map["merchant"]
        try:
            create_user_or_merchant("merchant", "ra@gmail.com", 10,
                                    input_type["report_object"], input_type["class_name"])
            assert False
        except Exception as e:
    ...
    def test_main_create_new_merchant_name_format_negative(self):
        ...
        try:
            create_user_or_merchant(
                "m123", "r@gmail.com", 1000, input_type["report_object"], input_type["class_name"])
            assert False
        except Exception as e:
            assert e.message == "Name format invalid"
    ...
    def test_create_new_transaction_positive(self, mock_check_transct):
        ...
        assert create_new_transaction(self.class_map["user"]["report_object"].get("ravinder"),
                                      self.class_map["merchant"]["report_object"].get(
                                          "merchant"),
    ...
    def test_main_create_user(self, mock_create_user):
        assert main("new user ravinder ra@gmail.com 10000",
